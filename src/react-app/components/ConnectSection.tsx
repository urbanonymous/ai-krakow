...
const ConnectSection = () => {
  const connections = [
    ...
    {
      title: "X Thread",
      description: "Follow #AIKrakow on X for notes, links, and project references.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    {
      title: "Email",
      description: "Got a resource, correction, or idea to share? Reach us at urbano@ai-krakow.com.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
      ...
      <div className="container-custom">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Follow the reference links or send a note if something useful belongs here.
          </p>
        </div>
